...
public class EditMovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bEditMovie = findViewById(R.id.bEditMovie);
        ...
        Movie movie = getIntent().getExtras().getParcelable(MainActivity.MOVIE_DATA);

        etName.setText(movie.name);
        etDescription.setText(movie.description);
        sGenre.setSelection(movie.genre);
        sbRating.setProgress(movie.rating);
        etYear.setText(movie.year);
        etIMDB.setText(movie.IMDB);
